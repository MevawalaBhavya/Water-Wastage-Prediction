...
dataframe = dataframe.drop(['Wastage'], axis=1)
# print(dataframe)
...
independent_X = dataframe[['Date', 'Supply', 'Zone', 'Ward', 'Population']]
dependent_y = dataframe['Usage'].astype(int)
...
rsCV = RandomizedSearchCV(xgbreg, params, n_jobs=2)
...
joblib.dump(clf, "Usage_Model.sav")
