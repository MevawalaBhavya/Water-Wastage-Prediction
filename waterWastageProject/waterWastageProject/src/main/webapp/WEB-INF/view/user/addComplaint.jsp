    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Add Complaint</h3>
				</div>
			</div>
		</div>
				 ...
				 <!-- Basic Forms -->
				  <div class="box">
					...
					<div class="box-body">
					  <div class="row">
						<div class="col">
							<f:form  action="/insertComplain" modelAttribute="complaintVO" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-12">									
										<div class="form-group">
											<h5>Complain Subject <span class="text-danger">*</span></h5>
											<div class="controls">
												<f:input class="form-control" path="complainSubject" placeholder="Complain Subject" required="required" data-validation-required-message="This field is required"  ></f:input>
											</div>
								        </div>										
										<div class="form-group">
											<h5>Complain Description <span class="text-danger">*</span></h5>
											<div class="controls">
												<f:textarea rows="5" path="complainDescription" class="form-control" required="required" placeholder="Complain Description"></f:textarea>
											</div>		
										</div>
										<div class="form-group">
											<h5>Upload photo <span class="text-danger">*</span></h5>
											<div class="controls">
