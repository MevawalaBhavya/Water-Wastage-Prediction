<header class="main-header">	
	  <div class="p-10 clearfix float-left logo-block">
		...
		<!-- Logo -->
		<a href="<%request.getContextPath();%>/index.html" class="logo">
		  <!-- logo-->
		  <span class="logo-lg">
			<!--   <img src="adminResources/image/logo-light-text.png" alt="logo" class="light-logo">
			  <img src="adminResources/image/logo-dark-text.png" alt="logo" class="dark-logo"> -->
		  </span>
		</a>	  
	  </div>
    <!-- Header Navbar -->
		...
		<!-- 	<ul class="header-megamenu nav">
				...
				<li class="btn-group nav-item">
					...
					<div class="dropdown-menu">
						<div class="dropdown-menu-header-inner bg-img" style="background-image: url('adminResources/image/landscape1.jpg');" data-overlay="5">
      ...
      <div class="navbar-custom-menu">
       ...
       <!--    <li class="dropdown messages-menu">
              ...
              <li>
                ...
                <ul class="menu inner-content-div">
                  <li>start message
                    <a href="#">
                      <div class="pull-left">
                        <img src="adminResources/image/user2-160x160.jpg" class="rounded-circle" alt="User Image">
                      </div>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="adminResources/image/user3-128x128.jpg" class="rounded-circle" alt="User Image">
                      </div>
                      <div class="mail-contnet">
                         <h4>
                          Nullam tempor
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="adminResources/image/user4-128x128.jpg" class="rounded-circle" alt="User Image">
                      </div>
                      <div class="mail-contnet">
                         <h4>
                          Proin venenatis
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<%request.getContextPath();%>/adminResources/image/avatar.png" class="img-fluid" alt="" />
            </a>
			<ul class="dropdown-menu scale-up">
              <!-- Menu Body -->
              <li class="user-body">
