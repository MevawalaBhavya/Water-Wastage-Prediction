    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Add Ward</h3>
				</div>
			</div>
		</div>
				 ...
				 <!-- Basic Forms -->
				  <div class="box">
					...
					<div class="box-body">
					  <div class="row">
						<div class="col">
							<f:form action="/admin/insertWard" modelAttribute="wardVO" method="post" >
								<div class="row">
									<div class="col-12">
									<div class="form-group">
										<h5> Zone<span class="text-danger">*</span></h5>
										<div class="controls">
											<f:select  required="required" class="form-control" path="zoneVO.id">
									...
									<div class="form-group">
										...
										<div class="controls">
											<f:select  required="required" class="form-control" path="areaVO.id">
												<c:forEach items="${areaList}" var="i">	
												<f:option value="${i.id}">${i.areaName}</f:option>
													</c:forEach><br>
												</f:select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="controls">
											<f:input type="text"  path="wardName" class="form-control" placeholder="Ward Name" required="required" data-validation-required-message="This field is required"></f:input> 
										</div>										
									</div>
									<div class="form-group">
										<h5>Description <span class="text-danger">*</span></h5>
										<div class="controls">
											<f:textarea rows="5" path="wardDescription" class="form-control" required="required" placeholder="Ward Description"></f:textarea>
										</div>
									</div>
									<f:hidden path="id"/>		
