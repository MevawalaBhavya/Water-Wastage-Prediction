    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Complaints</h3>
				</div>
					...
					<tbody>
						<c:forEach items="${complainList}" var="i">
							<tr>
								...
								<td>${i.reply}</td>
								<td><a href="<%=request.getContextPath()%>/document/demo/${i.fileName}" target="_blank">view</a></td>
								<td>
									<c:if test="${i.complainStatus eq 'pending'}">
										<a href="giveReply?id=${i.id}">Reply</a>
									</c:if>
