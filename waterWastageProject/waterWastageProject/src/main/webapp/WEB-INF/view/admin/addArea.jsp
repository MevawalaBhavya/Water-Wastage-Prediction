				 ...
				 <!-- Basic Forms -->
				  <div class="box">
					...
					<div class="box-body">
					  <div class="row">
						<div class="col">
							<f:form  action="/admin/insertArea" modelAttribute="areaVO" method="post">
								<div class="row">
									<div class="col-12">
										...
										<div class="form-group">
											...
											<div class="controls">
												<f:input class="form-control" path="areaName" placeholder="Area name" required="required" data-validation-required-message="This field is required"  ></f:input>
											</div>	
										</div>	
										<div class="form-group">
											<h5>Area Description <span class="text-danger">*</span></h5>
											<div class="controls">
												<f:textarea rows="5" path="areaDescription" class="form-control" required="required" placeholder="Area Description"></f:textarea>
											</div>
										</div>		
										<f:hidden path="id"/>
