    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Zone Table</h3>
				</div>
        ...
        <div class="col-12">         
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Zone Table</h4>
            ...
            <div class="box-body">
				<div class="table-responsive">
				  <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
					...
					<tbody>
						<c:forEach items="${zone.zoneList}" var="i">
							<tr>
								<td>${i.id}</td>
								<td>${i.zoneName}</td>
								<td>
									<a href="/admin/editZone?id=${i.id}">Edit</a>
									<a href="/admin/deleteZone?id=${i.id}">Delete</a>									
								</td>	
							</tr>	
						</c:forEach>
					</tbody>				  
