    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Add Water Data</h3>
				</div>
			</div>
		</div>
				 ...
				 <!-- Basic Forms -->
				  <div class="box">
					...
					<div class="box-body">
					  <div class="row">
						<div class="col">
							<f:form action="/admin/insertWaterData" modelAttribute="WaterDataVO" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-12">
									...
									<div class="form-group">
										...
										<div class="controls">
											<f:select  required="required" class="form-control" path="wardVO.id">
