    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Add Zone</h3>
				</div>
			</div>
		</div>
				 ...
				 <!-- Basic Forms -->
				  <div class="box">
					...
					<div class="box-body">
					  <div class="row">
						<div class="col">
							<f:form  action="/admin/insertZone" modelAttribute="zoneVO" method="post">
								<div class="row">
									<div class="col-12">
										<div class="form-group">
											<h5> Add Zone<span class="text-danger">*</span></h5>
											<div class="controls">
												<f:select name="zone" id="select" required="required" class="form-control" path="zoneName">
													<f:option value="">Select Zone</f:option>
													<f:option value="north">North</f:option>
													<f:option value="south">South</f:option>
													<f:option value="east">East</f:option>
													<f:option value="west">West</f:option>
												</f:select>
											</div>							
										</div>
										<f:hidden path="id"/>
