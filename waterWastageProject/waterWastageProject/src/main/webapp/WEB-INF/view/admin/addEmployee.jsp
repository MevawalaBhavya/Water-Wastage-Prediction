    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Add Employee</h3>
				</div>
			</div>
		</div>
				 ...
				 <!-- Basic Forms -->
				  <div class="box">
					...
					<div class="box-body">
					  <div class="row">
						<div class="col">
							<f:form  action="insertEmployee" modelAttribute="registerVO" method="post">
								<div class="row">
									<div class="col-12">
										...
										<div class="form-group">
											...
											<div class="controls">
												<f:input class="form-control" path="firstName" placeholder="First name" required="required" data-validation-required-message="This field is required"  ></f:input>
											</div>	
										</div>
										...
										<div class="form-group">
											...
											<div class="controls">
												<f:input class="form-control" path="loginVO.username" placeholder="User name" required="required" data-validation-required-message="This field is required"  ></f:input>
											</div>	
										</div>
										...
										<div class="form-group">
											...
											<div class="controls">
												<f:input class="form-control" path="mobileNumber" placeholder="Mobile Number" required="required" data-validation-required-message="This field is required"  ></f:input>
											</div>	
										</div>	
										<div class="form-group">
											<h5>Address <span class="text-danger">*</span></h5>
											<div class="controls">
												<f:textarea rows="5" path="address" class="form-control" required="required" placeholder="Address"></f:textarea>
											</div>
										</div>		
