    ...
    <!-- Content Header (Page header) -->
	  <div class="content-header d-none d-md-block">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title br-0">Ward Table</h3>
				</div>
				  ...
				  <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
					...
					<tbody>
						<c:forEach items="${wardList}" var="i">
							<tr>
								<td>${i.id}</td>
								<td>${i.zoneVO.zoneName}</td>
								<td>${i.areaVO.areaName}</td>
								<td>${i.wardName}</td>
								<td>${i.wardDescription}</td>
								<td>
									<a href="/admin/editWard?id=${i.id}">Edit</a>
									<a href="/admin/deleteWard?id=${i.id}">Delete</a>
